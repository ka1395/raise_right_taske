...
TextStyle black22regular() => const TextStyle(
  fontSize: 22.0,
  fontFamily: AppThemData.regular,
  color: AppThemData.assetColorGrey600,
);
TextStyle black24regular() => const TextStyle(
  fontSize: 24.0,
  color: AppThemData.assetColorGrey600,
  fontFamily: AppThemData.regular,
);
...
TextStyle white22regular() => const TextStyle(
  fontSize: 22.0,
  color: AppThemData.assetColorGrey100,
  fontFamily: AppThemData.regular,
);
TextStyle white24regular() => const TextStyle(
  fontSize: 24.0,
  color: AppThemData.assetColorGrey100,
  fontFamily: AppThemData.regular,
);
